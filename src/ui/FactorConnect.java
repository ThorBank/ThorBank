 ...
 */
public class FactorConnect extends JFrame {
    public FactorConnect() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //======== panel2 ========
            {
                ...
                //---- factorConnect ----
                factorConnect.setText("Factor Connect ");
                factorConnect.setBackground(new Color(204, 0, 51));
                factorConnect.setForeground(Color.white);
                factorConnect.setHorizontalAlignment(SwingConstants.RIGHT);
                factorConnect.setFont(new Font("FrankRuehl", Font.BOLD, 30));
                panel2.add(factorConnect);
                factorConnect.setBounds(460, 50, 265, 40);
                ...
                separator2.setBounds(520, 85, 200, 30);
